...
def cli():
    ...
    def parse_args():
        ...
        parser = argparse.ArgumentParser(
            ...
            epilog="""
Examples:
  cgm-mcp-modelless                     # Start with default config
  cgm-mcp-modelless --config config.json  # Use custom config file
  cgm-mcp-modelless --log-level DEBUG   # Enable debug logging
