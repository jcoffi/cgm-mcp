...
def show_ollama_cloud_usage():
    ...
    print("# 设置模型名称")
    print("export CGM_LLM_MODEL=gemma4:cloud")
    print("# 可选：设置自定义API基础URL")
    print("# export CGM_LLM_API_BASE=https://ollama.com")
    print("```")
    print()
    print("### 代码配置示例:")
    print("```python")
    ...
    print('    model="gemma4:cloud",')
    print('    api_key=os.getenv("CGM_LLM_API_KEY"),')
    print('    api_base=os.getenv("CGM_LLM_API_BASE", "https://ollama.com"),')
    ...
    print('    "provider": "ollama_cloud",')
    print('    "model": "gemma4:cloud",')
    print('    "api_base": "https://ollama.com",')
    print('    "temperature": 0.1,')
